...
# Generate Results
***
Results can be saved as html and csv files using **generateReport** function. A **Results** folder will be created in the **current working directory**. 

**generateReport** takes result object and method used in epismoker function. Users have to provide a name for the output html file. 

#### Please note that result object from epismoker function must be saved as variable **result**.
