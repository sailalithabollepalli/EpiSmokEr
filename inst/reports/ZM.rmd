...
# Results from Zhang Method (ZM)
Date: `r format(Sys.time(), '%d %B, %Y')` 

```{r echo=FALSE, results="asis"}
out <- htmlTable::txtRound(result_ZM, 2, excl.cols=1)
write.csv(out, file.path(outputDir, "EpiSmokEr_Results_ZhangMethod.csv"), row.names=FALSE)
